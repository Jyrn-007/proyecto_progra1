...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label3->Location = System::Drawing::Point(401, 311);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(459, 175);
			this->label3->TabIndex = 5;
			this->label3->Text = L"Somos una empresa dedicada a crear sistemas de inventarios para pequeños negocios"
				L"  ";
			...
			this->ClientSize = System::Drawing::Size(1155, 613);
